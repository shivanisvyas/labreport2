...
expName = 'Orientation Discrimination Task Tutorial 2 ...'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/ashwini/Documents/Orientation Discrimination Task Tutorial 2 ..._lastrun.py',
